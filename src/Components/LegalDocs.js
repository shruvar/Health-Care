    ...
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Health Care, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Health Care, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Health Care is designed to simplify healthcare access. You can choose
